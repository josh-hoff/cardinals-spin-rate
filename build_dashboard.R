...
build_cardinals_dashboard <- function(
  ...
  writeLines('function setZoom(inn){zoomedInning=inn;var label=currentView==="outing"?inn+" IP":ordinal(inn)+" inning";document.getElementById("zoomLabel").textContent="Zoomed: "+label;document.getElementById("zoomBar").style.display="flex";render();}', out)
