...
build_cardinals_dashboard <- function(
  ...
  writeLines('addPitcherOpts(grouped.active,"active");', out)
  writeLines('if(grouped.injured.length){addDivider("Injured List");addPitcherOpts(grouped.injured,"injured");}', out)
